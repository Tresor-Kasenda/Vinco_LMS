            ...
            <div class="row clearfix">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="bold-text"><p>recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p> </div>
                        <div class="btn-box">
                            <Link to={'/'} class="theme-btn btn-style-four"><span class="txt">Download</span></Link>
                        </div>
                    </div>
                </div>
