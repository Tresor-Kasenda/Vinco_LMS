                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Edit Exams Session</h3>
                        </div>
                        <div class="nk-block-head-content">
                        ...
                        <div class="card-inner">
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    ...
                                    @endif
                                    <form action="{{ route('admins.exam.session-exams.update', $sessionExam->id) }}" method="post" class="form-validate mt-4" novalidate="novalidate">
                                        @csrf
                                        @method('PUT')
                                        <div class="row g-gs">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input
                                                            ...
                                                            id="name"
                                                            name="name"
                                                            value="{{ old('name') ?? $sessionExam->name }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input
                                                            ...
                                                            value="{{ old('start_date') ?? $sessionExam->start_date }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input
                                                            type="text"
                                                            class="form-control time-picker @error('end_date') error @enderror"
                                                            id="end_date"
                                                            name="end_date"
                                                            value="{{ old('end_date') ?? $sessionExam->end_date }}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        >{{ old('note') ?? $sessionExam->note }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
