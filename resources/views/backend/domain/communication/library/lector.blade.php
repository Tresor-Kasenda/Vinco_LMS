...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/pdf/pdfjs/viewer.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets/pdf/pdf-flip.css')}}"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url({{asset('assets/pdf/pics/loader.gif')}}) center no-repeat #fff;
        }
    </style>
</head>
            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer" >
                    ...
                    <div id="toolbarViewerRight">
                        ...
                        {{--                        <button onclick="location.href = '{{$home}}';" class="toolbarButton hiddenMediumView" title="Home">Back To Website--}}
                        {{--                        </button>--}}
...
<script src="{{asset('assets/pdf/turnjs/turn.min.js')}}"></script>
<script src="{{asset('assets/pdf/turnjs/zoom.min.js')}}"></script>
<script src="{{asset('assets/pdf/pdfjs/l10n.js')}}"></script>
<script src="{{asset('assets/pdf/pdfjs/build/pdf.js')}}"></script>
<script src="{{asset('assets/pdf/pdfjs/debugger.js')}}"></script>
<script src="{{asset('assets/pdf/pdfjs/viewer.js')}}"></script>
<script src="{{asset('assets/pdf/pdf-flip.js?v=1.1.1.1.1.1')}}"></script>
