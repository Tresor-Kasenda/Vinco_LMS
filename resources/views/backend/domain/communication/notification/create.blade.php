                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Notification Create</h3>
                        </div>
                        <div class="nk-block-head-content">
                    ...
                    <div class="card">
                        <div class="card-inner">
                            <div class="row justify-content-center">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <form action="{{ route('admins.communication.notification.store') }}" method="post" class="form-validate" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row g-gs">
                                            <div class="col-md-12">
