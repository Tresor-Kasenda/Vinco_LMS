@extends('backend.domain.communication.chat.layouts.app')
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body container">
                    ...
                    id="message-container" style="overflow-y: scroll; height:400px;" v-chat-scroll>
                    ...
                    @empty
                    @endforelse
                    <message v-for="(messages, id) in chat "
                        v-bind:key="id"
                        v-bind:message = "message.message"
                        v-bind:username = "message.user.username"
                        v-bind:user_id = "message.user.id"
