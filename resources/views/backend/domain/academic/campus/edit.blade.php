                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Professor ({{ strtoupper($campus->name) }})</h3>
                        </div>
                        <div class="nk-block-head-content">
                ...
                <div class="nk-block">
                    <div class="card">
                        <div class="card-inner">
                            <form action="{{ route('admins.campus.update', $campus->key) }}" method="post" class="form-validate" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row g-gs">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input
                                                    ...
                                                    id="images"
                                                    name="images"
                                                    value="{{ old('images') ?? $campus->images }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                required>
                                                <option label="role" value="{{ $campus->user_id }}">{{ $campus->user->name }}</option>
