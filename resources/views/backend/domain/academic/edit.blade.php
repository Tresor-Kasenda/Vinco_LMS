                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Annee academique ({{ $academic->startDate }}-{{ $academic->endDate }} )</h3>
                        </div>
                        <div class="nk-block-head-content">
                ...
                <div class="nk-block">
                    <div class="card">
                        <div class="card-inner">
                            <form action="{{ route('admins.academic-years.update', $academic->id) }}" method="post" class="form-validate" novalidate="novalidate">
                                @csrf
                                @method('PUT')
                                <div class="row g-gs">
                                    <div class="col-md-6">
