                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Edition de l'exercice ({{ $lesson->name }} )</h3>
                        </div>
                        <div class="nk-block-head-content">
                ...
                <div class="nk-block">
                    <div class="card">
                        <div class="card-inner">
                            <div class="row">
                                <div class="col-md-6">
                                    <form action="{{ route('admins.academic.exercice.update', ['exercice' => $lesson->key]) }}" method="post" class="form-validate" novalidate="novalidate" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row g-gs">
                                            <div class="col-md-12">
