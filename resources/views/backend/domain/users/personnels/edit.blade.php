...
@section('title', "Edition du personnel")
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">
                                Edit Personnel/<strong class="text-primary small">{{ strtoupper($employee->username) }}</strong>
                            </h3>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="toggle-expand-content" data-content="more-options">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <a class="btn btn-outline-light d-none" href="{{ route('admins.users.staffs.index') }}">
                        ...
                        <div class="card-inner">
                            <div class="row">
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <form action="{{ route('admins.users.staffs.update', $employee->key) }}" method="post" class="form-validate mt-3" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row g-gs">
                                                <div class="col-md-12">
