...
@section('title', "Historique Administration")
                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Historique des administrateurs</h3>
                        </div>
                        <div class="nk-block-head-content">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li>
                                                            <form action="{{ route('admins.administrator.restore', $administrator->key) }}" method="POST">
                                                                @method('PUT')
                                                        ...
                                                        <li>
                                                            <form action="{{ route('admins.administrator.remove', $administrator->key) }}" method="POST" onsubmit="return confirm('Voulez vous supprimer');">
                                                                @method('DELETE')
                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
