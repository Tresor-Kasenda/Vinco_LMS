...
@section('title', "Mise a jours de l'administration")
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">
                                Administrateur/<strong class="text-primary small">{{ strtoupper($administrator->username) }}</strong>
                            </h3>
                        </div>
                        <div class="nk-block-head-content">
                ...
                <div class="nk-block">
                    <div class="card">
                        <div class="card-inner">
                            <form action="{{ route('admins.administrator.update', $administrator->key) }}" method="post" class="form-validate" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row g-gs">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-md btn-primary">Update admin</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
