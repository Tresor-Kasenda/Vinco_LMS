                        ...
                        <div class="card h-100">
                            <div class="card-inner">
                                ...
                                <ul class="nk-top-products">
                                    ...
                                    <li class="item">
                                        <div class="user-avatar sq bg-warning-dim me-3"><span>AD</span>
                                        </div>
                                        <div class="info">
                                    ...
                                    <li class="item">
                                        <div class="user-avatar sq bg-danger-dim me-3"><span>WD</span>
                                        </div>
                                        <div class="info">
                                    ...
                                    <li class="item">
                                        <div class="user-avatar sq bg-primary-dim me-3"><span>ML</span>
                                        </div>
                                        <div class="info">
                            ...
                            <div class="card-inner-group">
                                <div class="card-inner">
                                    <div class="card-title-group">
                                        ...
                                        <div class="card-tools">
                                            <a href="instructor-list.html" class="link">View All</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="review-item d-flex justify-content-between">
                                        ...
                                        <div class="review-status">
                                            <ul class="review-stars d-flex">
                                                ...
                                                <li>
                                                    <em class="icon ni ni-star-half-fill text-warning"></em>
                                                </li>
                                            </ul>
                            ...
                            <div class="nk-ecwg nk-ecwg4 h-100">
                                <div class="card-inner flex-grow-1">
                                    <div class="card-title-group mb-4">
                                        ...
                                        <div class="card-tools">
                                            <div class="dropdown">
                                                <a href="#" class="dropdown-toggle link link-light link-sm dropdown-indicator" data-bs-toggle="dropdown">
                                                    30 Days
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
