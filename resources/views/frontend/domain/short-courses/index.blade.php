...
@section('content')
    ...
    <section class="courses-page-section style-two">
        ...
        <div class="pattern-layer-four" style=></div>
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="course-block-three col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                        ...
                        <div class="overlay-content-box">
                            ...
                            <div class="text">There are many variations of Lorem Ipsum available, but the majority have
                                suffered.
                            </div>
                            <ul class="lists">
                                <li>The majority have suffered alteration</li>
                                <li>The majority have suffered alteration in somePhasellus enim magna, varius et commodo
                                    ut,
                                </li>
                ...
                <div class="course-block-four col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                        ...
                        <div class="overlay-content-box">
                            ...
                            <div class="clearfix">
                                <div class="price">$49 <span>$100.99</span></div>
                                <div class="hovers">11.5 total hours . All Levels</div>
                            </div>
                            <div class="text">There are many variations of Lorem Ipsum available, but the majority have
                                suffered.
