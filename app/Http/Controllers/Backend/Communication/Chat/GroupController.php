...
class GroupController extends Controller
{
    ...
    {
        return view('backend.domain.communication.chat.group.create');
    }
    ...
    {
        return view('backend.domain.communication.chat.group.join');
    }
    ...
    public function show_group($id)
    {
        ...
        return view('backend.domain.communication.chat.group.show', compact('group', 'messages'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.domain.communication.chat.group.edit', compact('group'));
    }
    ...
    public function members_list($id)
    {
        ...
        return view('backend.domain.communication.chat.group.members_list', compact(['group_members', 'group_id']));
    }
